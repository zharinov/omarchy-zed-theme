...
pub const EDITOR_COMPOSITE_HEADROOM: f64 = 1.30;
pub const EDITOR_BASE_TEXT_CONTRAST: f64 =
    EDITOR_OVERLAY_TEXT_CONTRAST * EDITOR_COMPOSITE_HEADROOM * 1.08;
...
pub const LIGHT_DIFF_HOLLOW_OPACITY: f64 = 0.12;
pub const LIGHT_DIFF_BORDER_OPACITY: f64 = 0.48;
pub const LIGHT_DIFF_WORD_OPACITY: f64 = 0.06;
pub const DARK_DIFF_LINE_OPACITY: f64 = 0.12;
pub const DARK_DIFF_HOLLOW_OPACITY: f64 = 0.06;
pub const DARK_DIFF_BORDER_OPACITY: f64 = 0.36;
pub const DARK_DIFF_WORD_OPACITY: f64 = 0.04;
pub const LIGHT_DIFF_LINE_TARGET_CONTRAST: f64 = 1.08;
pub const DARK_DIFF_LINE_TARGET_CONTRAST: f64 = 1.06;
pub const LIGHT_DIFF_LINE_MINIMUM_DELTA_E: f64 = 0.010;
pub const DARK_DIFF_LINE_MINIMUM_DELTA_E: f64 = 0.008;
pub const DIFF_OVERLAY_PIGMENT_CHROMA_FLOOR: f64 = 0.230;
pub const DIFF_OVERLAY_MINIMUM_CHROMA: f64 = 0.025;
pub const CONFLICT_FILL_CONTRAST: f64 = 1.30;
